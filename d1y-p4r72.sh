...
# add init settings
wget --no-check-certificate https://raw.githubusercontent.com/0xACE8/hyp3r-v_x64_l3d3/main/99-init-settings -O package/base-files/files/etc/uci-defaults/99-init-settings

# Change to my banner
sudo rm package/base-files/files/etc/banner
wget --no-check-certificate https://raw.githubusercontent.com/0xACE8/hyp3r-v_x64_l3d3/main/banner -O package/base-files/files/etc/banner
